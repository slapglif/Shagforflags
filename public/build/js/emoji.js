(function ($) {
	$.fn.emoji = function (params) {
		...
		this.each(function (n, input) {
			...
			var $list = $('<div id="emoji-box">').css(defaults.listCSS).css(settings.listCSS);
			...
			$list.insertAfter(".custom-btn-open-emoji");

			$(".custom-btn-emoji").on('click', clickEmoji);
			$(".custom-btn-open-emoji").on('click', showEmoji);
		});
